---
title: "[Docs Review]ViewModel overview"
...
* **Because of their scoping, use ViewModels as implementation details of a screen level state holder. <mark>Use at screen level, Don't use them as state holders of reusable UI components such as chip groups or forms.</mark> Otherwise, you'd get the same ViewModel instance in different usages of the same UI component under the same ViewModelStoreOwner.**
